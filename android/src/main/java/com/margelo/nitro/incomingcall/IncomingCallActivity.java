...
import com.margelo.nitro.incomingcall.R;
...
public class IncomingCallActivity extends AppCompatActivity implements DefaultHardwareBackBtnHandler {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (bundle.containsKey("mainComponent") && bundle.getString("mainComponent") != null) {
      ...
      ReactFragment.Builder reactNativeFragmentBuilder = new ReactFragment.Builder();
        Fragment reactNativeFragment;
        try {
          java.lang.reflect.Method setComponentNameMethod = ReactFragment.Builder.class.getMethod("setComponentName", String.class);
          setComponentNameMethod.invoke(reactNativeFragmentBuilder, mainComponent);
          java.lang.reflect.Method setLaunchOptionsMethod = ReactFragment.Builder.class.getMethod("setLaunchOptions", Bundle.class);
          setLaunchOptionsMethod.invoke(reactNativeFragmentBuilder, bundle);
          reactNativeFragment = reactNativeFragmentBuilder.build();
        } catch (Exception ignored) {
          reactNativeFragment = new ReactFragment.Builder().build();
        }
